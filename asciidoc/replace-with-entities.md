Update the below text by replacing matching strings with corresponding entities found in the entity file referenced by the "include::" directive in  cody://current-file.
